...
def add_diary(
    ...
    with db.cursor() as cursor:
        ...
        cursor.execute(sql, (user_id, diary.title, diary.contents, diary.emotion, diary.photo_url))
        db.commit()
    db.close()
...
def edit_diary(
    ...
    with db.cursor() as cursor:
        ...
        cursor.execute(sql, (diary.title, diary.contents, diary.emotion, diary.photo_url, user_id, diary.date))
        db.commit()
    db.close()
